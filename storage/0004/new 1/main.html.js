...
<title>Official Website of the Southern Exports</title>
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="keywords" content="Southern, Sri Lanka, Hambantota, Exports, Southernexports, Dehydrated, Dehydrated Foods, Food, Foods, Spices">
				...
				<div class="container">
					<div class="navbar-header page-scroll">
						<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
							<span class="sr-only">dehydrated foods</span>
							<span class="icon-bar"></span>
							<span class="icon-bar"></span>
							<span class="icon-bar"></span>
						</button>
						<h2><a class="navbar-brand" href="index.html"><i class="fa fa-angle-double-right w3-logo" aria-hidden="true"></i>Southern Exports<i class aria-hidden="true"></i></a></h2>
						<p>Healthy products, Low cost</p>
					</div> 
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a class="page-scroll scroll" href="#about">Your Cart</a></li>
							<li><a class="page-scroll scroll" href="#gallery">Ratings</a></li>
							<li><a class="page-scroll scroll" href="#packages">Products</a></li>
							<li><a class="page-scroll scroll" href="#blog">Tracking</a></li>
							<li><a class="page-scroll scroll" href="#testimonials">About Us</a></li>
							<li><a href="Binidu/login.php">Login</a></li>
						</ul>
					</div>
						...
						<div class="w3layouts-banner-top">
							<div class="container">
								<div class="agileits-banner-info jarallax">
									<h3 class="agile-title">DEHYDRATED FOODS</h3>
								</div>	
							</div>
						</div>
					</li>
						...
						<div class="w3layouts-banner-top w3layouts-banner-top2">
							<div class="container">
								<div class="agileits-banner-info2 jarallax">
									<h3 class="agile-title">Delicious taste</h3>
								</div>
							</div>
						</div>
					</li>
						...
						<div class="w3layouts-banner-top w3layouts-banner-top3">
							<div class="container">
								<div class="agileits-banner-info3 jarallax">
									<h3 class="agile-title">High quality</h3>
								</div>
							</div>
						</div>
					</li>
...
<div class="wthreelocationsaits" id="gallery">
		<div class="container">
			...
			<section class="grid3d vertical" id="grid3d">
				<div class="grid-wrap">
					<div class="grid">
						<figure class="col-md-4 effect-zoe"><img src="images/10.jpg" alt="wanderlust">
					  <figcaption><h4>LONDON</h4></figcaption>
					  </figure>
						<figure class="col-md-4 effect-zoe"><img src="images/11.jpg" alt="wanderlust">
					  <figcaption><h4>AUSTRALIA</h4></figcaption>
					  </figure>
						<figure class="col-md-4 effect-zoe"><img src="images/18.jpg" alt="wanderlust">
					  <figcaption><h4>EGYPT</h4></figcaption>
					  </figure>
						<figure class="col-md-4 effect-zoe"><img src="images/11.jpg" alt="wanderlust">
					  <figcaption><h4>AUSTRALIA</h4></figcaption>
					  </figure>
						<figure class="col-md-4 effect-zoe"><img src="images/16.jpg" alt="wanderlust">
					  <figcaption><h4>AMERICA</h4></figcaption>
					  </figure>
						<figure class="col-md-4 effect-zoe"><img src="images/10.jpg" alt="wanderlust">
					  <figcaption><h4>LONDON</h4></figcaption>
					  </figure>
				...
				<div class="content">
					<div>
						<div class="dummy-img dummy-img-1"><img src="images/10.jpg" alt="wanderlust"></div>
						<p class="dummy-text aitsheadingw3">LONDON</p>
					...
					<div>
						<div class="dummy-img dummy-img-2"><img src="images/11.jpg" alt="wanderlust"></div>
						<p class="dummy-text aitsheadingw3">AUSTRALIA</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-3"><img src="images/18.jpg" alt="wanderlust"></div>
						<p class="dummy-text aitsheadingw3">EGYPT</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-4"><img src="images/11.jpg" alt="wanderlust"></div>
						<p class="dummy-text aitsheadingw3">AUSTRALIA</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-5"><img src="images/16.jpg" alt="wanderlust"></div>
						<p class="dummy-text aitsheadingw3">AMERICA</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-6"><img src="images/10.jpg" alt="wanderlust"></div>
						<p class="dummy-text aitsheadingw3">LONDON</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-7"><img src="images/10.jpg" alt="wanderlust"></div>
						<p class="dummy-text aitsheadingw3">LONDON</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-8"><img src="images/18.jpg" alt="wanderlust"></div>
						<p class="dummy-text aitsheadingw3">EGYPT</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
					<div>
						<div class="dummy-img dummy-img-9"><img src="images/16.jpg" alt="wanderlust"></div>
						<p class="dummy-text aitsheadingw3">AMERICA</p>
						<p class="dummy-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					</div>
...
<div class="packages jarallax" id="packages">
	<div class="container">
			...
			<div class="w3-package-grids">
				<div class="col-md-4 col-sm-4 col-xs-6 wthree-s1 text-center pricing">
					<div class="w3l-price"><span class="sicon">$150</span><p>per person</p></div>
					<div class="price-top">
					...
					<div class="price-bottom">
						<ul>
							<li><b>3 nights</b> four days</li>
							<li>consectetur</li>
							<li>accomodation</li>
							<li>molestie</li>
						</ul><div class="w3-service w3l-button">
							<a href="#" data-toggle="modal" data-target="#myModal">view details</a>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-6 wthree-s1 text-center pricing p2">
					<div class="w3l-price"><span class="sicon">$250</span><p>per person</p></div>
					<div class="price-top">
				...
				<div class="col-md-4 col-sm-4 col-xs-6 wthree-s1 text-center pricing p3">
					<div class="w3l-price"><span class="sicon">$350</span><p>per person</p></div>
					<div class="price-top">
...
<div class="blog jarallax" id="blog">
	<div class="container">
			<h3 class="w3l-head text-center">latest blog posts</h3>
				...
				<div class="col-md-4 col-sm-4 col-xs-4 w3-blog">
					...
					<div class="agileits-blog-bottom">	
						<div class="w3-agile-post-info">
							...
							<div class="clearfix"></div>
							<a href="#" data-toggle="modal" data-target="#myModal"><h5>25 jan:</h5>	<h4>simple blog post</h4></a>
							<p>Suspendisse in nisl at ipsum molestie dignissim. Pellentesque est nisi, blandit eget aliquam sed, consequat nec risus...</p>
						</div>
						<i class="w3-agile-share fa fa-share-alt" aria-hidden="true"></i>
				...
				<div class="col-md-4 col-sm-4 col-xs-4 w3-blog b2">
					...
					<div class="agileits-blog-bottom">		
						<div class="w3-agile-post-info">
							...
							<div class="clearfix"></div>
							<a href="#" data-toggle="modal" data-target="#myModal"><h5>20 feb:</h5>	<h4>simple blog post</h4></a>
							<p>Suspendisse in nisl at ipsum molestie dignissim. Pellentesque est nisi, blandit eget aliquam sed, consequat nec risus...</p>
						</div>
						<i class="w3-agile-share fa fa-share-alt" aria-hidden="true"></i>
						<div class="w3-blog w3l-button">
				...
				<div class="col-md-4 col-sm-4 col-xs-4 w3-blog b3">
					...
					<div class="agileits-blog-bottom">		
						<div class="w3-agile-post-info">
							...
							<div class="clearfix"></div>
							<a href="#" data-toggle="modal" data-target="#myModal"><h5>15 mar:</h5>	<h4>simple blog post</h4></a>
							<p>Suspendisse in nisl at ipsum molestie dignissim. Pellentesque est nisi, blandit eget aliquam sed, consequat nec risus...</p>
						</div>
						<i class="w3-agile-share fa fa-share-alt" aria-hidden="true"></i>
						<div class="w3-blog w3l-button">
	...
	<div class="testimonials jarallax" id="testimonials">
		<div class="container">
			<h3 class="w3l-head text-center">Testimonials</h3>
		</div>
			...
			<div class="agileits_w3layouts-contact">
				<div class="col-md-6 col-sm-12 agileinfo-contact-left">
					<div class="w3ls-address">
						...
						<h6>Address:</h6><p>4952 East Avenue,Rocky Mount,Missouri.</p>
					</div>
					<div class="w3ls-address mail">
						<span class="fa fa-envelope icon" aria-hidden="true"></span>
						<h6>Mail:</h6><a href="mailto:info@example.com">info@example.com</a>
					</div>
					<div class="w3ls-address">
						<span class="fa fa-phone icon" aria-hidden="true"></span>
						<h6>Phone:</h6><p>+12 345 678</p>
					</div>
...
<div class="w3_agileits-footer">
	<div class="container">
		<div class="col-md-9 col-sm-12 wthree-footer-left">
			...
			<h5>call us<span>+94 71 3702599</span></h5><!--
		...
		<div class="col-md-3 col-sm-12 wthree-footer-right">
			...
			<div class="w3-mail">
			<ul>
				<li><span class="fa fa-envelope icon" aria-hidden="true"></span><a href="mailto:info@example.com">southernexportsh@gmail.com</a></li>
				<li><span class="fa fa-phone" aria-hidden="true"></span><p>+94 71 3702599 </p></li>
			</ul>	
			</div>
		</div>
		<div class="clearfix"></div>
...
<p><font color="#ffffff"></font></p><center><font color="#ffffff">© 2023 Southern Exports. No 30, Jail Street, Hambantota, All Rights Reserved. (Gov. Reg. No: H/01/2570)<br><br>
 (this site is underconstruction)</font></center><p></p>
<div class="copyright">
		
</div>

  <script defer src="js/jquery.flexslider.js"></script>
	<script type="text/javascript">$(window).load(function(){$('#carousel').flexslider({animation:"slide",controlNav:false,animationLoop:true,slideshow:false,itemWidth:102,itemMargin:5,asNavFor:'#slider'});$('#slider').flexslider({animation:"slide",controlNav:false,animationLoop:true,slideshow:true,sync:"#carousel",start:function(slider){$('body').removeClass('loading');}});});</script>
...
<script type="text/javascript">$('.jarallax').jarallax({speed:0.5,imgWidth:1366,imgHeight:768})</script>
